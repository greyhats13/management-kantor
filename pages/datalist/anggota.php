  ...
  <body style="background-color: #f9f9f9">
    ...
    <div class="bounceInUp animated">
      <table class="table" id="data-anggota">
        ...
        <tbody>
          <?php
            $sql = "SELECT tb_anggota.id_anggota, tb_anggota.nama, GROUP_CONCAT(tb_jabatan.jabatan SEPARATOR ', ') as 'jabatan', tb_anggota.email, tb_anggota.jenis_kelamin, tb_anggota.status  FROM `tb_anggota` JOIN jabatan_anggota ON tb_anggota.id_anggota = jabatan_anggota.id_anggota JOIN tb_jabatan ON tb_jabatan.id_jabatan = jabatan_anggota.id_jabatan GROUP BY tb_anggota.id_anggota";
           ...
           <div class="modal-content">  
                ...
                <div class="modal-body">  
                     <form method="post" action="pages/proses/proses_edit-anggota.php">  
                        ...
                        <div class="form-group">
                          <label>Status</label>  
                          <select class="form-control select " data-placeholder="Pilih Status"name="status" 
                                  style="width: 100%; color: #212121;"
