...
//list($one, $two) = explode(",", $_SESSION['jabatan'], 2);
    ...
    $sql2 = "SELECT SUM(credit_in) AS total_credit FROM tb_detail_absen WHERE id_anggota='$_SESSION[id_anggota]' AND credit_stat='unpaid' GROUP BY id_anggota";
                        ...
                        <li id="menu_absensi" class="treeview">
                            ...
                            <li id="menu_master" class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li>
                                        <a href="tampil/data-anggota-detail">
                                            <i class="glyphicon glyphicon-user"></i>
                                            <span> Data Anggota Detail</span>
                                        </a>
                                    </li>
                                        <li>
...
if ((isset($_GET["action"])) && ($_GET["action"] == "tampil") && ($_GET["sidebar-menu"] == "home")) {
    ...
    }elseif ((isset($_GET["action"])) && ($_GET["action"] == "tampil") && ($_GET["sidebar-menu"] == "data-anggota-detail")) {
        include_once "pages/datalist/anggota-detail.php";
